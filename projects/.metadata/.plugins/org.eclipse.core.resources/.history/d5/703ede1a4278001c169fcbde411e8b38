...
/****************************EXTRAS****************************************/
#define DIO_u8OUTPUT	(u8) 1
#define DIO_u8INPUT		(u8) 0
#define DIO_u8HIGH		(u8) 1
#define DIO_u8LOW		(u8) 0
/*********************Function Prototypes*********************************/
u8 DIO_u8SetPinDirection(u8 Copy_u8Port ,u8 Copy_u8Pin,u8 Copy_u8Direction);//set direction for specific pin

u8 DIO_u8SetPortDirection(u8 Copy_u8Port ,u8 Copy_u8Direction);//set direction for entire port
