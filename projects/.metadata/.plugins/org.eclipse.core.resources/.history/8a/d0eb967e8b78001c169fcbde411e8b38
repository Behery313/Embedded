...
/*****************************************************************/
	...
	#define PORTA_PIN_4_DIR					INPUT  
	#define PORTA_PIN_5_DIR					INPUT  
	#define PORTA_PIN_6_DIR					INPUT  
	#define PORTA_PIN_7_DIR					INPUT  
	/*PORTA PIN INITIALISATIONS*/
	#define PORTA_PIN_0_InitValue			0  
	#define PORTA_PIN_1_InitValue			0  
	#define PORTA_PIN_2_InitValue			0  
	#define PORTA_PIN_3_InitValue			0  
	#define PORTA_PIN_4_InitValue			0  
	#define PORTA_PIN_5_InitValue			0  
	#define PORTA_PIN_6_InitValue			0  
	#define PORTA_PIN_7_InitValue			0  
	
/*****************************************************************/
/************************PORTB************************************/
/*****************************************************************/	
	/*PORTB DIRECTIONS*/
	#define PORTB_PIN_0_DIR					INPUT  
	...
	#define PORTB_PIN_2_InitValue			0  
...
/*****************************************************************/
	/*PORTC DIRECTIONS*/
	#define PORTC_PIN_0_DIR					INPUT  
	#define PORTC_PIN_1_DIR					INPUT  
	#define PORTC_PIN_2_DIR					INPUT  
...
/*****************************************************************/
	/*PORTD DIRECTIONS*/
	#define PORTD_PIN_0_DIR					INPUT  
	#define PORTD_PIN_1_DIR					INPUT  
	#define PORTD_PIN_2_DIR					INPUT  
	#define PORTD_PIN_3_DIR					INPUT  
	#define PORTD_PIN_4_DIR					INPUT  
	#define PORTD_PIN_5_DIR					INPUT  
	#define PORTD_PIN_6_DIR					INPUT  
	#define PORTD_PIN_7_DIR					INPUT  
