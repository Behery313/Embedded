...
void STEPPER_VoidRotate(u8 STEPPER_u8RotationDirection,f32 STEPPER_u8Angle)
{
	...
	if(STEPPER_u8RotationDirection==CW)
	{
		for(u16 Local_u16Iterator=1;Local_u8Iterator<=Local_u16StepperSteps;Local_u16Iterator++)
		if(STEPPER_u8CoilIndex==0)
		{
			DIO_SetPinValue(STEPPER_PORT,STEPPER_BLUE_PIN,DIO_u8LOW);
			DIO_SetPinValue(STEPPER_PORT,STEPPER_PINK_PIN,DIO_u8HIGH);
			DIO_SetPinValue(STEPPER_PORT,STEPPER_YELLOW_PIN,DIO_u8HIGH);
			DIO_SetPinValue(STEPPER_PORT,STEPPER_ORANGE_PIN,DIO_u8HIGH);
			STEPPER_u8CoilIndex=1;
			_delay_ms(2);
		}
		else if(STEPPER_u8CoilIndex==1)
		{
		DIO_SetPinValue(STEPPER_PORT,STEPPER_BLUE_PIN,DIO_u8HIGH);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_PINK_PIN,DIO_u8LOW);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_YELLOW_PIN,DIO_u8HIGH);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_ORANGE_PIN,DIO_u8HIGH);
		...
		DIO_SetPinValue(STEPPER_PORT,STEPPER_BLUE_PIN,DIO_u8HIGH);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_PINK_PIN,DIO_u8HIGH);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_YELLOW_PIN,DIO_u8LOW);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_ORANGE_PIN,DIO_u8HIGH);
		...
		DIO_SetPinValue(STEPPER_PORT,STEPPER_PINK_PIN,DIO_u8HIGH);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_YELLOW_PIN,DIO_u8HIGH);
		DIO_SetPinValue(STEPPER_PORT,STEPPER_ORANGE_PIN,DIO_u8LOW);
		STEPPER_u8CoilIndex=0;
		_delay_ms(2);
		}
	}
	/*COUNTER CLOCKWISE*/
	else if (STEPPER_u8RotationDirection==CCW)
	{
		for(u16 Local_u16Iterator=1;Local_u8Iterator<=Local_u16StepperSteps;Local_u16Iterator++)
		if(STEPPER_u8CoilIndex==0)
		{
